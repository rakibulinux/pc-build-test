...
const ProfilePage = () => {
  ...
  return (
    <div className="" style={{ textAlign: "center" }}>
      <Head>
        <title>PC Builder User Profile</title>
      </Head>
      <div className="flex flex-col p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700 items-center gap-4 justify-center">
        <Image
